...
const sidebarData: SidebarData = {
  logo: {
    src: "/public/wall-v-logo.png",
    alt: "Wall-V Logo",
    title: "Wall-V App",
    description: "CMS, E-Commerce & ERP App",
  },
  navGroups: [
    {
      title: "Overview",
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="size-8 rounded-lg">
                <AvatarImage src={user.avatar} alt={user.name} loading="eager" />
...
const AppSidebar = ({ user, ...props }: React.ComponentProps<typeof Sidebar> & { user?: AuthUser; }) => {
  return (
    <Sidebar {...props}>
      <SidebarHeader>
...
export default function Dashboard({ className, children }: ApplicationShell1Props) {
  const [user, setUser] =
